...
#................... Botones analisis de datos .................................
	    ...
	    lblAnalizar = Label(bicho, text="\nANALIZAR\n DATOS ", fg = ("black"), bg = ("white"), font = ("Century Schoolbook L",10)).place(x=140+x2, y=256)             
            ...
            btnAnimacion= Button(bicho, text= "Simulación", width=5, height=1, command= Simular).place(x=140+x2, y=380) 	
...
#---------------------- Botones Presentacion -----------------------------------------------------------    	
	...
	imgPendulo=PhotoImage(file="Imagenes/pendulo.gif")
        ...
        lblFisinfor = Label(bicho, text=" GRUPO DE FISICA E INFORMATICA ", fg = ("black"), bg = ("white"), font = ("Century Schoolbook L",10)).place(x=356, y=371+yn)
